...
export const collections = [
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=800&h=1067&fit=crop',
    ...
    liked: false,
    isNew: true,
    description: 'Chrám sv. Barbory, kostnice a vyhliadky nad riekou Vrchlicí. 5 zastávok, 8 km.',
  },
  {
    id: 'c2',
    title: 'Podél Labe z Poděbrad',
    author: { name: 'Eva Malá', avatar: 'https://i.pravatar.cc/150?img=32', verified: false },
    coverImage: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=800&h=1067&fit=crop',
    ...
    liked: true,
    isNew: false,
    description: 'Pokojná cyklo-pěší trasa lemovaná topoly, ideální na víkendové odpoledne.',
  },
  {
    id: 'c3',
    title: 'Kolínské rozhledny',
    author: { name: 'Petr Novotný', avatar: 'https://i.pravatar.cc/150?img=15', verified: false },
    coverImage: 'https://images.unsplash.com/photo-1476231682828-37e571bc172f?w=800&h=1067&fit=crop',
    ...
    liked: false,
    isNew: false,
    description: 'Tři rozhledny s výhledem na meandry Labe, vhodné i pro rodiny s dětmi.',
  },
  {
    id: 'c4',
    title: 'Lesní stezky u Vlašimi',
    author: { name: 'Jana Dvořáková', avatar: 'https://i.pravatar.cc/150?img=48', verified: false },
    coverImage: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=1067&fit=crop',
    ...
    liked: false,
    isNew: false,
    description: 'Stinné lesní úseky perfektní na horké letní dny, s pramenem u poloviny trasy.',
  },
];

export const organizationPosts = [
  {
    id: 'o1',
    org: {
      name: 'Národní park České Švýcarsko',
      avatar: 'https://i.pravatar.cc/150?img=60',
      verified: true,
    },
    image: 'https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=800&h=1067&fit=crop',
  ...
  },
  {
    id: 'o2',
    org: {
      name: 'Krkonošský národní park',
      avatar: 'https://i.pravatar.cc/150?img=65',
      verified: true,
    },
    image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=800&h=1067&fit=crop',
    createdAt: '2026-08-25T16:30:00Z',
    caption: 'Sněžka se probouzí do podzimu. Chodník na vrchol je aktuálně bez omezení.',
    likes: 431,
    comments: [
      { id: 'cm3', user: 'outdoor_petr', text: 'Skvělá zpráva, jdeme tento víkend!' },
    ],
    sponsored: false,
  },
  {
    id: 'o3',
    org: {
      name: 'CHKO Moravský kras',
      avatar: 'https://i.pravatar.cc/150?img=68',
      verified: false,
    },
    image: 'https://images.unsplash.com/photo-1447752875215-b2761acb3c5d?w=800&h=1067&fit=crop',
